...
public class CommonTests {
    public static int musicTest(WebDriver driver, WebDriverWait wait, PrintWriter logger, PrintWriter loggerHTML, int errorCounter, String sub_url) throws InterruptedException {
        ...
        try {
            ...
            System.out.println("Unable to move element to Top 5 list");
        }
        Thread.sleep(1000);
        ...
        if (top5.size()==0){
            ...
            loggerHTML.println("<tr><th>No items in Top 5 list</th><th>1. Open Recommender<br>2.Drag and drop item to Top 5 list<br>3.Observe</th><th>" + HelpfulMethods.now() + " </th><th>No items in Top 5 list</th><th>Items in Top 5 list</th></tr>");
        ...
        try {
            ...
            System.out.println("Unable to move element to Likes list");
        }
    ...
    public static int TVTest(WebDriver driver, WebDriverWait wait, PrintWriter logger, PrintWriter loggerHTML, int errorCounter, String sub_url) throws InterruptedException {
        System.out.println("Checking Recommender TV Shows");
        loggerHTML.println("Testing Recommender TV Shows<br>");
        loggerHTML.flush();
        ...
        loggerHTML.println("<font color=\"green\">Testing Recommender TV Shows - Complete</font><br><br>");
        loggerHTML.flush();
        System.out.println("Checking Recommender TV - Complete");
        return errorCounter;
    }
}
